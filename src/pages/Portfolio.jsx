...
const projects = [
  { id: 1, title: 'FinFlow SaaS Platform', category: 'SaaS', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80', desc: 'A comprehensive financial management platform built for SMBs. Features include invoicing, expense tracking, payroll, and real-time reporting. Serves 500+ businesses globally.', tech: ['React', 'Node.js', 'MongoDB', 'Stripe', 'Redis', 'AWS'], url: 'https://finflow-demo.com', client: 'FinTech Solutions Inc.', color: '#6366f1' },
  { id: 2, title: 'HealthOS Patient Portal', category: 'Web App', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&q=80', desc: 'An intelligent healthcare platform connecting patients, doctors, and hospitals. Features AI symptom checker, telemedicine, and EHR management.', tech: ['Next.js', 'Python', 'PostgreSQL', 'TensorFlow', 'WebRTC'], url: 'https://healthos-demo.com', client: 'MedTech Corp', color: '#06b6d4' },
